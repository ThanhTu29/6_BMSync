...
urlpatterns = [
    ...
    path('admin/quan-ly-thiet-bi/them/', views.admin_them_thiet_bi, name='admin_them_thiet_bi'),
    ...
    path('admin/phieu-muon-bao-tri/send-notification/<str:request_id>/', views.send_maintenance_notification, name='send_maintenance_notification'),
